...
(default, 'Goku Super Saiyan', 'goku.jpg', 'Goku in his Super Saiyan form from Dragon Ball Z.', 14.99, 0, 2, null, '2024-03-01 12:00:00'),
(default, 'Sailor Moon', 'sailormoon.jpg', 'Sailor Moon figure from the classic anime series.', 13.99, 20, 2, null, '2024-01-15 09:00:00'),
(default, 'Mickey Mouse', 'mickey.jpg', 'Classic Mickey Mouse collectible figure.', 9.99, 60, 1, null, '2024-01-10 14:00:00'),
(default, 'Iron Man', 'ironman.jpg', 'Iron Man figure with metallic finish.', 15.99, 25, 3, null, '2024-01-20 16:45:00'),
(default, 'Wonder Woman', 'wonderwoman.jpg', 'Wonder Woman figure from DC Comics.', 12.49, 35, 4, null, '2024-02-05 13:15:00'),
(default, 'Naruto Uzumaki', 'naruto.jpg', 'Naruto figure in his classic outfit.', 13.49, 45, 2, null, '2024-01-25 11:45:00'),
(default, 'SpongeBob SquarePants', 'spongebob.jpg', 'SpongeBob figure from the animated series.', 10.99, 50, 1, null, '2024-03-01 10:30:00'),
(default, 'Captain America', 'captainamerica.jpg', 'Captain America with his shield.', 12.99, 30, 3, null, '2024-03-05 15:00:00'),
(default, 'Thanos', 'thanos.jpg', 'Thanos figure with Infinity Gauntlet.', 16.99, 15, 3, null, '2024-02-20 17:20:00'),
(default, 'Joker', 'joker.jpg', 'Joker figure from DC Comics.', 11.49, 40, 4, null, '2024-01-18 12:30:00'),
(default, 'Luffy', 'luffy.jpg', 'Monkey D. Luffy from One Piece.', 14.49, 35, 2, null, '2024-02-25 09:15:00'),
(default, 'Elsa', 'elsa.jpg', 'Elsa figure from Frozen.', 13.99, 25, 1, null, '2024-02-10 13:50:00'),
(default, 'Deadpool', 'deadpool.jpg', 'Deadpool in a classic pose.', 12.99, 50, 3, null, '2024-02-01 12:10:00'),
(default, 'Superman', 'superman.jpg', 'Superman figure from DC Comics.', 12.99, 45, 4, null, '2024-03-01 08:45:00'),
(default, 'Vegeta', 'vegeta.jpg', 'Vegeta from Dragon Ball Z.', 14.99, 30, 2, null, '2024-01-05 10:10:00'),
(default, 'Pikachu', 'pikachu.jpg', 'Pikachu figure from Pokémon.', 11.99, 60, 2, null, '2024-01-15 14:50:00'),
...
(default, 'Thor', 'thor.jpg', 'Thor figure with Mjolnir.', 15.99, 20, 3, null, '2024-03-01 08:45:00'),
